...
public class FFSSMJUnitTests {
    ...
    public void setUp() {
        ...
        Pl1 = new Plongee(Bermudes, M1, LocalDate.of(2020,11,25), 40,50);
        Pl2 = new Plongee(M1);
    ...
    /**
     * Test d'ajout de participants à une plongee
     * 
     */
     @Test
    public void testAjouteParticipant()throws Exception{
        ...
        assertEquals("Ce plongeur a déjà été inscrit pour cette plongée",
                thrown.getMessage(),
